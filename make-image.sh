...
PACKAGES+=" kmod-mii kmod-macvlan kmod-usb-net kmod-usb-wdm kmod-usb-net-qmi-wwan uqmi luci-proto-qmi \
kmod-usb-net-cdc-ether kmod-usb-serial-option kmod-usb-serial kmod-usb-serial-wwan qmi-utils \
kmod-usb-serial-qualcomm kmod-usb-acm kmod-usb-net-cdc-ncm kmod-usb-net-cdc-mbim umbim \
modemmanager luci-proto-modemmanager libmbim libqmi kmod-usb-ohci luci-proto-mbim \
kmod-usb-net-huawei-cdc-ncm kmod-usb-net-cdc-ether kmod-usb-net-rndis kmod-usb-net-sierrawireless kmod-usb-uhci kmod-usb-serial-sierrawireless \
kmod-usb2 kmod-usb-ehci usb-modeswitch usbutils kmod-usb3 mbim-utils xmm-modem"
