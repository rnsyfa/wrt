...
PACKAGES+=" kmod-mii kmod-macvlan comgt-ncm kmod-usb-net kmod-usb-net-cdc-ncm kmod-usb-net-huawei-cdc-ncm kmod-usb-wdm \
kmod-usb-net-cdc-ether kmod-usb-ohci usb-modeswitch kmod-usb-net-rndis kmod-usb-uhci kmod-usb-net-sierrawireless \
kmod-usb-serial-sierrawireless kmod-usb2 kmod-usb-ehci usbutils"

# Modem Tools
PACKAGES+=" luci-app-3ginfo-lite"
...
# Nas and storage
PACKAGES+=" kmod-usb-storage luci-app-diskman luci-app-tinyfm"
